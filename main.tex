...
\includegraphics[width=1.0\textwidth]{results/figures/pca_yield.png}[tb]
...
\includegraphics[width=1.0\textwidth]{results/figures/measures_probe_CPI (n_pc=128).png}[tb]
...
\includegraphics[width=1.0\textwidth]{results/figures/measures_CPI (n_pc=128).png}[tb]
